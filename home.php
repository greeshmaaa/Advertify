                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a class="post-title" data-animation="fadeInUp" data-delay="300ms">The most powerful element in advertising is the truth.</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a class="post-title" data-animation="fadeInUp" data-delay="300ms">Creative without strategy is called ‘Art’. Creative with strategy is called ‘Advertising’.</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a class="post-title" data-animation="fadeInUp" data-delay="300ms">What you say in advertising is more important than how you say it.</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="img/bg-img/advertisement.jpg" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <!-- Sidebar Widget -->
                <div class="single-sidebar-widget">
                    <a href="#" class="add-img"><img src="img/bg-img/advertisement3.jpg" alt=""></a>
                </div>
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <div class="single-trending-post">
                        <img src="img/bg-img/19.jpg" alt="" width="261" height="195">
                        <div class="post-content">
                            <a href="#" class="post-cata">#BlackLivesMatter</a>
                            <a class="post-title">Thousands join Black Lives Matter protest in London</a>
                        </div>
                    </div>
                    
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="img/bg-img/20.jpg" alt="" width="261" height="195">
                        <div class="post-content">
                            <a href="#" class="post-cata">Local</a>
                            <a class="post-title">Explore Hill Stations in and around Mangalore</a>
                        </div>
                    </div>

                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="img/bg-img/21.jpg" alt="" width="261" height="195">
                        <div class="post-content">
                            <a href="#" class="post-cata">Pandemic</a>
                            <a class="post-title">COVID-19: 5 Things to Know</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-thumbnail mb-50">
                                    <video width="400" height="300" autoplay muted loop>
                                      <source src="videoads/22.mp4" type="video/mp4">
                                    </video>
                                </div>
                                <!-- Post Contetnt -->
                                <div class="post-content">
                                    ...
                                    <a class="post-title">Have the most delicious food delivered at your doorstep</a>
                                    <p>Knight Bite is a Mangalore and Manipal based food service company known for it's finger-licking yummy food throughout Mangalore and beyond. Download the Knight Bite App right now and make your quarantine enjoyable and tasty!</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <div class="most-viewed-videos-slide owl-carousel">
                    ...
                    <div class="single-blog-post style-4">
                        ...
                        <div class="post-content">
                            <a href="single-post.html" class="post-title">Check out Today's Weather in Mangalore</a>
                            <div class="post-meta d-flex">
                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 338</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-post style-4">
                        ...
                        <div class="post-content">
                            <a href="single-post.html" class="post-title">COVID 19: Udupi and Dakshina Kannada report over 145  positive cases</a>
                            <div class="post-meta d-flex">
                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 517</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-post style-4">
                        ...
                        <div class="post-content">
                            <a href="single-post.html" class="post-title">Protest in Mangalore Railway Station</a>
                            <div class="post-meta d-flex">
                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1057</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="post-sidebar-area right-sidebar mt-30 mb-30 box-shadow">
            ...
            <!-- Sidebar Widget -->
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="img/bg-img/advertisement2.jpg" alt=""></a>
            </div>
