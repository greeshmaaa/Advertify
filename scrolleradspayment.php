...
.col-lg-8 {
  ...
  <div class="mag-breadcrumb py-5">
	...
	<tbody>
	<?php
	$sql= "SELECT payment.*,advertiser.*  FROM payment LEFT JOIN advertiser ON payment.advertiserid=advertiser.advertiserid WHERE payment.status!='' AND payment.transaction_type='ScrollerAdvertisement'";
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		<?php	 
		echo"	<td>Total  - ₹$rs[paidamt]<br>CGST - ₹$cgst<br>SGST - ₹$sgst <br colspan='1'><b>Grand Total - ₹$gtotal</b></td>
	...
	<tfoot>
		<tr>
			...
			<th></th>
			<th>Grand Total</th>
			<th colspan='2'> ₹<?php echo $totcollection; ?></th>
		</tr>
	</tfoot>
</table>
				</div>
