  ...
  <div class="mag-breadcrumb py-5">
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		echo "<td>$rs[Advttitle]</td>
			<td><a href='videoads/$rs[Videoadvt]'  download>Download Video</a></td>
			<td>$rs[status]</td>
			<td><a href='add_videoads.php?editid=$rs[videoaddid]' class='btn  btn-info' >Edit</a> | <a href='view_videoads.php?delidd=$rs[videoaddid]' onclick='return confirmdelete()' class='btn btn-danger'>Delete</a></td>
		</tr>";
	}
	?>		
	</tbody>
