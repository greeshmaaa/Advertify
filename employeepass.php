...
if(isset($_POST[update_password]))
{
	...
	$sql = "UPDATE employee SET password='$_POST[newpass]' WHERE password='$_POST[oldpass]' AND employeeid='$_SESSION[employeeid]'";
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		echo "<script>window.location.assign('employeehome.php');</script>";
		
	}
	else
	{
		echo "<script>alert('Entered details not valid..'); </script>";
		echo "<script>window.location.assign('employeepass.php');</script>";
	}
