...
{
	$sql = "SELECT * FROM advertiser WHERE emailid='$_POST[email]' AND status='Active'";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_num_rows($qsql) == 1)
	{
		$rslogin = mysqli_fetch_array($qsql);
		$_SESSION['custnewpasswordid'] = $rslogin['advertiserid'];
		$currenturl = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/customer_resetpassword.php";
		$to = $rslogin['emailid'];
		$subject = "Password Recovery Mail from TV Advertisement Portal...";
		$txt = "<b>Hello $rslogin[advertisername] ,</b> <br><br> We recently received a request to recover the relicForge Account $rslogin[emailid] . If you sent request, please click on this <a href='$currenturl'><b>Reset Link</b></a> to Change password. This password reset link will expire in 24 hours.";
		$headers = "MIME-Version: 1.0" . "\r\n";
		$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		$headers .= "From: advertify1234@gmail.com";
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <form action="" method="post" onsubmit="return validateform()">
                            ...
                            <button type="submit"name="submit" class="btn mag-btn mt-30" name="login">Reset Password</button>
